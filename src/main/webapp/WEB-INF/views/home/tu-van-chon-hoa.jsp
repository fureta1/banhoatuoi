...
<head>
    ...
    <title>Kết quả tư vấn chọn hoa - FlowerShop</title>
    ...
    <style>
        * {
        ...
        /* Mega Menu – style giống index.jsp, nội dung lấy từ _mega-menu.jsp */
        .mega-menu {
            background: white;
        ...
        .advice-header-left h1 i {
            color: #f6ad55;
        }

        .advice-header-left p {
            color: #4a5568;
            font-size: 15px;
        }
        ...
        /* Product Grid & Card – giống index.jsp */
        .product-grid {
            display: grid;
...
<div class="main-wrapper">
    ...
    <div class="advice-header">
        <div class="advice-header-left">
            <h1>
                ...
                Kết quả tư vấn chọn hoa
            </h1>
            <p>Chúng tôi đã lọc các mẫu hoa phù hợp với lựa chọn của bạn.</p>

            <div class="advice-tags">
                <div class="advice-tag">
                    <i class="fas fa-tag"></i>
                    Chủ đề: ${displayCategoryLabel}
                </div>
                <div class="advice-tag">
                    <i class="fas fa-dollar-sign"></i>
                    Mức giá: ${displayPriceLabel}
                </div>
            </div>
        </div>
    ...
    <!-- SECTION: SẢN PHẨM PHÙ HỢP -->
    <div class="home-section">
        <div class="home-section-header">
            <h2>
                Sản phẩm phù hợp
                <c:if test="${not empty adviceProducts}">
                    <span>(${fn:length(adviceProducts)} sản phẩm)</span>
                </c:if>
            </h2>
        </div>

        <c:choose>
            <c:when test="${empty adviceProducts}">
                <div class="empty-result">
                    <i class="fas fa-box-open"></i>
                    <h3>Rất tiếc, chưa tìm được mẫu hoa phù hợp.</h3>
                    <p>Bạn có thể đổi mức giá hoặc chủ đề tại trang chủ, hoặc xem các gợi ý thêm bên dưới.</p>
                </div>
            </c:when>
            <c:otherwise>
                <div class="product-grid">
                    <c:forEach var="p" items="${adviceProducts}">
    ...
    <c:if test="${not empty relatedProducts}">
        <div class="home-section">
            <div class="home-section-header">
                <h2>
                    Gợi ý thêm cho bạn
                    <span>Một số mẫu hoa khác bạn có thể thích</span>
                </h2>
            </div>
